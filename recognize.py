...
classifier = cv2.CascadeClassifier(r'C:\Users\purpl\Desktop\cttcproj\cttcproj\haarcascade_frontalface_default (1).xml')

model = load_model("C:/Users/purpl/Desktop/cttcproj/cttcproj/final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['Mr.SR', 'Sonali', 'Sukanti', 'jimin']
    return labels[pred]
